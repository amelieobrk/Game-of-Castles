...
public class GameView extends View implements GameInterface {
    ...
    private JButton joker = createJoker();
    
    private JButton createJoker() {
    	JButton x = new JButton("Joker");
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (actionEvent.getSource() == joker) {
        	if (!game.getCurrentPlayer().getJoker().getUsed()) {
        		game.getCurrentPlayer().getJoker().setUseNow(true);
        	}
        }
    }
